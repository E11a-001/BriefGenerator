...
//
// Server:  import { CONTENT_TYPE_CONFIG, ... } from '../shared/config.js';
// Browser: public/shared-config.js (auto-derived copy, no ESM export)
// ============================================================
...
export const FUNNEL_STAGE_CAMPAIGN_GOALS = {
...
export function normalizeVideoFormat(value = '') {
...
export function buildAgreementPaymentClause(paymentMethod = '', paymentScheduleType = '') {
  const lines = [];
  const scheduleClause = PAYMENT_SCHEDULE_CONFIG[paymentScheduleType] || '';
